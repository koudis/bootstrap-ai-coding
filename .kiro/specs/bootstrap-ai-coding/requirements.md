...
- **[requirements-agents.md](./requirements-agents.md)** — Agent module implementations: Claude Code, Augment Code, and Build Resources. Requirements CC-1–CC-8, AC-1–AC-6, BR-1–BR-6.
