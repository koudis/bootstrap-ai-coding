...
Enabled agents:  claude-code, augment-code, build-resources, open-code, codex
```
...
| `--agents <ids>` | Comma-separated agent IDs to enable (default: `claude-code,augment-code,build-resources,open-code,codex`) |
